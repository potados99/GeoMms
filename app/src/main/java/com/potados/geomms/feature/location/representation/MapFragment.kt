    ...
    LocationSupportConnectionRecyclerViewAdapter.FriendClickListener
{
    ...
    private val adapter =
        LocationSupportConnectionRecyclerViewAdapter(this)
    ...
    private fun renderConnections(connections: List<LSConnection>?) {
    ...
    private fun handleIncomingRequest(requests: List<LSRequest>?) {

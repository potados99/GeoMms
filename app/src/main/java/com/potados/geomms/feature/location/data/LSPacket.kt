...
/**
 * LSServiceImpl 시스템의 정보 전달 단위입니다.
...
data class LSPacket(
    ...
    lateinit var parentConnection: LSConnection
    ...
    companion object {
        ...
        fun ofCreatingNewRequest(request: LSRequest) =
            LSPacket(
        ...
        fun ofAcceptingRequest(request: LSRequest) =
            LSPacket(
        ...
        fun ofRequestingUpdate(connection: LSConnection) =
            LSPacket(
        ...
        fun ofSendingData(connection: LSConnection, location: Location) =
            LSPacket(

...
class LocationSupportProtocol {
    ...
    companion object {
        ...
        fun parse(body: String): LocationSupportPacket? {
             ...
             */
            val typeNumber = with(Companion.Field.TYPE) {
        ...
        fun serialize(locationPacket: LocationSupportPacket): String? {
            ...
            val type = Companion.PacketType.values().find { it.number == locationPacket.type }
        ...
        fun findType(typeNum: Number): PacketType? {
            return Companion.PacketType.values().find { it.number == typeNum }
        }
        ...
        fun createRequestConnectPacket(id: Int, span: Long): LocationSupportPacket =
            LocationSupportPacket(
                Companion.PacketType.REQUEST_CONNECT.number, id, span,
                DEFAULT_DOUBLE,
                DEFAULT_DOUBLE
            )
        ...
        fun createAcceptConnectPacket(id: Int): LocationSupportPacket =
            LocationSupportPacket(
                Companion.PacketType.ACCEPT_CONNECT.number, id,
                DEFAULT_LONG,
                DEFAULT_DOUBLE,
                DEFAULT_DOUBLE
            )
        ...
        fun createDataPacket(id: Int, lat: Double, long: Double): LocationSupportPacket =
            LocationSupportPacket(
                Companion.PacketType.DATA.number, id,
                DEFAULT_LONG, lat, long
            )
        ...
        fun createRequestDataPacket(id: Int): LocationSupportPacket =
            LocationSupportPacket(
                Companion.PacketType.REQUEST_DATA.number, id,
                DEFAULT_LONG,
                DEFAULT_DOUBLE,
                DEFAULT_DOUBLE
            )
        ...
        fun createRequestDisconnectPacket(id: Int): LocationSupportPacket =
            LocationSupportPacket(
                Companion.PacketType.REQUEST_DISCONNECT.number, id,
                DEFAULT_LONG,
                DEFAULT_DOUBLE,
                DEFAULT_DOUBLE
            )

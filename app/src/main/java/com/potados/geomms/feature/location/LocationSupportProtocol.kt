...
class LocationSupportProtocol {
    ...
    companion object {
        ...
        fun parse(body: String): LocationSupportPacket? {
             ...
             */
            val typeNumber = with(LocationSupportPacket.Companion.Field.TYPE) {
        ...
        fun serialize(locationPacket: LocationSupportPacket): String? {
            ...
            val type = LocationSupportPacket.Companion.PacketType.values().find { it.number == locationPacket.type }
         ...
         */
        fun findType(typeNum: Number): LocationSupportPacket.Companion.PacketType? {
            return LocationSupportPacket.Companion.PacketType.values().find { it.number == typeNum }
        }
    }
}
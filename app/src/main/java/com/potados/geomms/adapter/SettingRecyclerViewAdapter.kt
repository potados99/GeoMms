...
import kotlinx.android.synthetic.main.fragment_setting_list_item.view.*
...
class SettingRecyclerViewAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.fragment_setting_list_item, parent, false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val item = mValues[position]
        holder.mIdView.text = "NIY"
        holder.mContentView.text = "NIY"
